...
public class EMACalculator extends ProcessWindowFunction<Tuple2<String, Float>, Indicator, String, TimeWindow> {
    ...
    @Override
    public void process(String key, Context context, Iterable<Tuple2<String, Float>> input, Collector<Indicator> out) throws Exception{
        float lastPrice = 0;
        float j38 = 38;
        float j100 = 100;
        for (Tuple2<String, Float> in: input) {
            lastPrice = in.f1;
        }
