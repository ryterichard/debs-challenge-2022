...
public interface BatchOrBuilder extends
   ...
   */
  java.util.List<de.tum.i13.bandency.Event> 
      getEventsList();
  /**
   * <code>repeated .Challenger.Event events = 4;</code>
   */
  de.tum.i13.bandency.Event getEvents(int index);
  /**
   * <code>repeated .Challenger.Event events = 4;</code>
   */
  int getEventsCount();
   ...
   * <code>repeated .Challenger.Event events = 4;</code>
   */
  java.util.List<? extends de.tum.i13.bandency.EventOrBuilder> 
      getEventsOrBuilderList();
  /**
   * <code>repeated .Challenger.Event events = 4;</code>
   */
  de.tum.i13.bandency.EventOrBuilder getEventsOrBuilder(
      int index);
}
