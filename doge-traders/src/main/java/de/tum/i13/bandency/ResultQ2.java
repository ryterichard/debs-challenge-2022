...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              crossoverEvents_ = new java.util.ArrayList<de.tum.i13.bandency.CrossoverEvent>();
              mutable_bitField0_ |= 0x00000001;
            }
            crossoverEvents_.add(
                input.readMessage(de.tum.i13.bandency.CrossoverEvent.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return de.tum.i13.bandency.ChallengerOuterClass.internal_static_Challenger_ResultQ2_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return de.tum.i13.bandency.ChallengerOuterClass.internal_static_Challenger_ResultQ2_fieldAccessorTable
  ...
  private java.util.List<de.tum.i13.bandency.CrossoverEvent> crossoverEvents_;
  /**
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  public java.util.List<de.tum.i13.bandency.CrossoverEvent> getCrossoverEventsList() {
    return crossoverEvents_;
  }
  /**
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  public java.util.List<? extends de.tum.i13.bandency.CrossoverEventOrBuilder> 
   ...
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  public de.tum.i13.bandency.CrossoverEvent getCrossoverEvents(int index) {
    return crossoverEvents_.get(index);
  }
  /**
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  public de.tum.i13.bandency.CrossoverEventOrBuilder getCrossoverEventsOrBuilder(
      int index) {
    return crossoverEvents_.get(index);
  }
  ...
  public static final class Builder extends
    ...
    private void ensureCrossoverEventsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        crossoverEvents_ = new java.util.ArrayList<de.tum.i13.bandency.CrossoverEvent>(crossoverEvents_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        de.tum.i13.bandency.CrossoverEvent, de.tum.i13.bandency.CrossoverEvent.Builder, de.tum.i13.bandency.CrossoverEventOrBuilder> crossoverEventsBuilder_;
    ...
    public Builder setCrossoverEvents(
        int index, de.tum.i13.bandency.CrossoverEvent value) {
      if (crossoverEventsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setCrossoverEvents(
        int index, de.tum.i13.bandency.CrossoverEvent.Builder builderForValue) {
      if (crossoverEventsBuilder_ == null) {
        ensureCrossoverEventsIsMutable();
     ...
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public Builder addCrossoverEvents(de.tum.i13.bandency.CrossoverEvent value) {
      if (crossoverEventsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addCrossoverEvents(
        de.tum.i13.bandency.CrossoverEvent.Builder builderForValue) {
      if (crossoverEventsBuilder_ == null) {
        ensureCrossoverEventsIsMutable();
    ...
    public Builder addAllCrossoverEvents(
        java.lang.Iterable<? extends de.tum.i13.bandency.CrossoverEvent> values) {
      if (crossoverEventsBuilder_ == null) {
        ensureCrossoverEventsIsMutable();
     ...
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public de.tum.i13.bandency.CrossoverEvent.Builder getCrossoverEventsBuilder(
        int index) {
     ...
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public de.tum.i13.bandency.CrossoverEvent.Builder addCrossoverEventsBuilder() {
      return getCrossoverEventsFieldBuilder().addBuilder(
          de.tum.i13.bandency.CrossoverEvent.getDefaultInstance());
    }
    /**
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public de.tum.i13.bandency.CrossoverEvent.Builder addCrossoverEventsBuilder(
        int index) {
      return getCrossoverEventsFieldBuilder().addBuilder(
          index, de.tum.i13.bandency.CrossoverEvent.getDefaultInstance());
    }
    /**
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public java.util.List<de.tum.i13.bandency.CrossoverEvent.Builder> 
         getCrossoverEventsBuilderList() {
      return getCrossoverEventsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        de.tum.i13.bandency.CrossoverEvent, de.tum.i13.bandency.CrossoverEvent.Builder, de.tum.i13.bandency.CrossoverEventOrBuilder> 
        getCrossoverEventsFieldBuilder() {
      if (crossoverEventsBuilder_ == null) {
