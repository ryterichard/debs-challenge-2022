...
public interface ResultQ2OrBuilder extends
   ...
   */
  java.util.List<de.tum.i13.bandency.CrossoverEvent> 
      getCrossoverEventsList();
  /**
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  de.tum.i13.bandency.CrossoverEvent getCrossoverEvents(int index);
  /**
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
   ...
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  java.util.List<? extends de.tum.i13.bandency.CrossoverEventOrBuilder> 
      getCrossoverEventsOrBuilderList();
  /**
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  de.tum.i13.bandency.CrossoverEventOrBuilder getCrossoverEventsOrBuilder(
      int index);
}
